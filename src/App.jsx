  ...
  days: [
    {
      ...
      events: [
        ...
        { 
          time: "13:00", type: "food", title: "Mercato Centrale", desc: "中央市場午餐", sub: "寄放行李", icon: <Utensils />, 
          lat: 45.4865, lng: 9.2016, query: "Mercato Centrale Milano",
          details: {
            history: "這個位於車站側翼的現代化市場，是為了復興車站作為城市社交中心的傳統而建。它匯集了義大利各地的工匠、麵包師傅和廚師。",
            highlights: ["手工義大利麵與羅馬披薩", "新鮮松露與海鮮料理", "西西里甜點 Cannoli"],
            tips: "這是一個開放式的美食廣場，建議先找到座位，再輪流去點餐。它是體驗義大利「慢食」文化的便捷入門。"
          }
        },
    ...
    },
    {
      ...
      events: [
        ...
        { 
          time: "16:00", type: "highlight", title: "學院橋", desc: "絕美夕陽 (16:30落)", icon: <Sun />, 
          lat: 45.4316, lng: 12.3286, query: "Ponte dell'Accademia",
          details: {
            history: "最初於 1854 年以鋼鐵建造，但因過於現代化被批評，1933 年改建為現在的木製橋樑。它是威尼斯僅有的四座跨越大運河的橋樑之一。",
            highlights: ["安康聖母聖殿的經典圓頂視角", "大運河最開闊的景色", "日落時分的金色波光"],
            tips: "這裡是攝影師公認拍攝威尼斯最美的地方，比里亞托橋更適合觀賞日落，因為視野更開闊。"
          }
        }
      ]
    },
    ...
    },
    {
      ...
      events: [
        { 
          time: "10:00", type: "activity", title: "聖母百花大教堂", desc: "參觀內部", icon: <Landmark />, 
          lat: 43.7731, lng: 11.2560, query: "Cathedral of Santa Maria del Fiore",
          details: {
            history: "由阿諾爾福·迪·坎比奧於 1296 年設計，旨在展現佛羅倫斯的財富與力量。布魯內萊斯基的穹頂解決了當時建築界最大的難題，開啟了文藝復興建築時代。",
            highlights: ["瓦薩里的《末日審判》壁畫 (穹頂內部)", "保羅·烏切洛的時鐘 (仍在運作)", "地下室的聖雷帕拉塔遺跡"],
            tips: "參觀教堂免費，但通常需要排隊。若您購買了 Brunelleschi Pass，請務必按照預約時間前往 Porta della Mandorla 進行登頂。"
          }
        },
    ...
    },
    {
      ...
      events: [
        ...
        { 
          time: "16:20", type: "highlight", title: "賈尼科洛山", desc: "最後一道夕陽", icon: <Sun />, 
          lat: 41.8913, lng: 12.4614, query: "Terrazza del Gianicolo",
          details: {
            history: "這裡曾是 1849 年加里波第保衛羅馬共和國的戰場。廣場上的加里波第雕像和正午的鳴砲儀式都是為了紀念這段歷史。",
            highlights: ["羅馬全景 (可看見萬神殿圓頂)", "保拉噴泉 (Fontana dell'Acqua Paola)", "正午鳴砲 (每日 12:00)"],
            tips: "這是羅馬著名的「情人山」，看完日落後，可以沿著蜿蜒的小路步行下山至 Trastevere 區享用晚餐。"
          }
        },
        { 
          time: "23:50", type: "activity", title: "聖天使城堡", desc: "跨年煙火", icon: <Clock />, 
          lat: 41.9031, lng: 12.4663, query: "Castel Sant'Angelo",
          details: {
            history: "最初建於公元 135 年作為哈德良皇帝的陵墓，後來成為軍事堡壘和教宗的避難所。著名的「博爾戈通道」將其與梵蒂岡相連。",
            highlights: ["大天使米迦勒銅像", "聖天使橋上的天使雕像 (貝尼尼設計)", "教宗寓所"],
            tips: "跨年夜這裡通常是煙火秀的背景，橋上是觀賞煙火的絕佳位置。"
          }
        }
      ]
    },
    ...
    },
    {
      ...
      events: [
        ...
        { 
          time: "15:40", type: "activity", title: "Polignano a Mare", desc: "濱海懸崖", icon: <Sun />, 
          lat: 40.9961, lng: 17.2195, query: "Lama Monachile",
          details: {
            history: "這座迷人的城鎮建立在被亞得里亞海浪侵蝕的石灰岩懸崖上，歷史可追溯至古希臘時期。著名的 Lama Monachile 海灣曾是古羅馬圖拉真大道 (Via Traiana) 的一部分。",
            highlights: ["懸崖上的白色舊城", "Lama Monachile 礫石海灘", "Grotta Palazzese (著名的洞穴餐廳)"],
            tips: "必嚐當地的「Caffè Speciale」，這是一種加了檸檬皮、奶油和阿瑪雷托酒 (Amaretto) 的特色咖啡。"
          }
        }
      ]
    },
    {
      ...
      events: [
        ...
        { 
          time: "19:00", type: "food", title: "Navigli 運河", desc: "Happy Hour", icon: <Utensils />, 
          lat: 45.4513, lng: 9.1722, query: "Navigli Grande",
          details: {
            history: "米蘭的運河系統始於 12 世紀，曾是用於運輸大理石建造米蘭大教堂的重要水道。達文西曾在此設計並改進了水閘系統。",
            highlights: ["達文西設計的水閘遺跡", "洗衣巷 (Vicolo dei Lavandai)", "運河兩岸的餐廳與酒吧"],
            tips: "傍晚時分是這裡最迷人的時刻。找一家提供「Aperitivo」(開胃酒時光) 的酒吧，點一杯 Aperol Spritz 享受米蘭夜生活。"
          }
        }
      ]
    },
    ...
    },
    {
      ...
      events: [
        ...
        { 
          time: "14:00", type: "food", title: "星巴克烘焙工坊", desc: "Piazza Cordusio", icon: <Clock />, 
          lat: 45.4651, lng: 9.1859, query: "Starbucks Reserve Roastery Milano",
          details: {
            history: "位於歷史悠久的科爾杜西奧廣場，前身是米蘭郵局大樓 (Palazzo delle Poste)。這是星巴克在義大利的第一家店，設計上極力致敬義大利的咖啡文化。",
            highlights: ["巨大的青銅烘豆機", "帕拉第奧式大理石馬賽克地板", "Arriviamo Bar 的咖啡調酒"],
            tips: "這裡不只是喝咖啡，更像是一座咖啡博物館。價格雖比一般義大利咖啡館高，但建築與體驗非常獨特。"
          }
        }
      ]
    },
